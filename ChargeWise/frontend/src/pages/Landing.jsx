        ...
        <div className="max-w-7xl mx-auto px-6 w-full relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-[480px] h-[480px]" style={{ animation: 'float 6s ease-in-out infinite' }}>
              <div className="absolute inset-0 rounded-full border border-primary-container/20 border-dashed" style={{ animation: 'spin 20s linear infinite' }}></div>
              <div className="absolute inset-10 rounded-full border border-primary-container/10 border-dashed" style={{ animation: 'spin 15s linear infinite reverse' }}></div>
              <div className="glass-card absolute inset-20 rounded-3xl flex items-center justify-center overflow-hidden shimmer-border">
                <div className="w-full h-full bg-gradient-to-br from-primary-container/20 via-surface-container to-secondary-container/10 flex items-center justify-center">
                  <div className="text-center">
                    <span className="material-symbols-outlined text-primary-container text-8xl mb-4 block" style={{ fontVariationSettings: "'FILL' 1" }}>electric_bolt</span>
                    <div className="text-primary-container font-bold text-2xl font-label-caps tracking-widest">BENGALURU</div>
                    <div className="text-on-surface-variant text-sm mt-1">Grid Intelligence Active</div>
                  </div>
                </div>
              </div>
              <div className="absolute top-2 right-4 w-16 h-16 glass-card rounded-xl flex flex-col items-center justify-center neon-glow">
                <span className="material-symbols-outlined text-primary-container" style={{ fontVariationSettings: "'FILL' 1" }}>electric_bolt</span>
                <span className="text-[10px] font-label-caps text-on-surface-variant">ACTIVE</span>
              </div>
    ...
    <section className="py-24 bg-surface-container-lowest border-y border-white/5">
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl">Deep-tech tools designed for energy operators, city planners, and infrastructure investors.</p>
          </motion.div>
              ...
              >
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="material-symbols-outlined text-primary-container bg-primary-container/10 p-3 rounded-xl">{icon}</span>
                ...
                {hasChat && (
                  <div className="bg-surface-container-high rounded-xl p-3 mt-4 border border-white/5">
                    <div className="text-[10px] text-primary-container font-label-caps mb-1">QUERYING AGENT...</div>
                ...
                {!action && !hasChart && !hasChat && (
                  <div className="flex gap-2 mt-4 overflow-hidden">
                    <span className="bg-primary-container/10 text-primary-container text-[10px] px-2 py-1 rounded border border-primary-container/20">Site Score: 9.8</span>
                    <span className="bg-white/5 text-on-surface-variant text-[10px] px-2 py-1 rounded border border-white/10">Near Highway</span>
                  </div>
                )}
              </motion.div>
            ))}
      ...
      <footer className="bg-surface-dim border-t border-outline-variant py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <div className="font-label-caps text-label-caps text-primary mb-1">ChargeWise AI Infrastructure</div>
            <p className="text-on-surface-variant text-sm">© 2024 ChargeWise AI. All rights reserved.</p>
          </div>
          <div className="flex gap-8 text-on-surface-variant text-sm">
            <a href="#" className="hover:text-primary-container transition-colors">API Docs</a>
